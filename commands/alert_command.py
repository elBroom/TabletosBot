...
def alert(context: CallbackContext) -> None:
    ...
    context.bot.logger.info(f'Send notification for {notification.chat_id}')
...
def save_history(context: CallbackContext, notification: Notification):
    ...
    context.bot.logger.info(f'Add row to history for {setting.chat_id}')
...
def later_query(update: Update, context: CallbackContext) -> None:
    ...
    context.bot.logger.info(f'Notification delayed for {notification.chat_id}')
    query = update.callback_query
